defmodule Swapnplay.Release do
  @moduledoc """
  ...
  def migrate do
    ...
    original_config = Application.get_env(@app, Swapnplay.Repo)

    Application.put_env(@app, Swapnplay.Repo,
    ...
    Application.put_env(@app, Swapnplay.Repo, original_config)
